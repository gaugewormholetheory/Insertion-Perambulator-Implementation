...
class PerambulatorInsertionInfo
{
  ...
  private:
    ...
    multi1d<int> twist_vector;

  public:
  
    PerambulatorInsertionInfo() = default;
 
    PerambulatorInsertionInfo(XmlReader& xml_in);
    ...
    multi1d<int> getTwistVector() const {return twist_vector;}
  ...
  private:
    ...
    void setTwistVector(XmlReader& xmlr, multi1d<int>& twist_vector);
    void set_info(XmlReader& xmlr);
};
